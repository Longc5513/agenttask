...
function PixelCharacter({ step }: { step: number }) {
  ...
  return (
    <div style={{ display: "flex", alignItems: "center", gap: "1.25rem", marginBottom: "1.5rem", padding: "1.25rem", background: "linear-gradient(135deg, #0f172a, #1e1b4b)", borderRadius: "1rem", border: "2px solid #6366f1", position: "relative", overflow: "hidden" }}>
      ...
      {/* Robot Image */}
      <div className={speaking ? "animate-pulse" : "pixel-float"} style={{ width: "80px", height: "80px", flexShrink: 0, borderRadius: "1rem", overflow: "hidden", boxShadow: speaking ? "0 0 20px rgba(99, 102, 241, 0.5)" : "0 0 10px rgba(99, 102, 241, 0.2)", transition: "box-shadow 0.3s" }}>
...
export default function Page() {
  ...
  return (
    <div style={{ minHeight: "100vh", background: "linear-gradient(rgba(10, 10, 15, 0.65), rgba(10, 10, 15, 0.78)), url('/bg.gif') center/cover no-repeat fixed", color: "#e0e0e0", fontFamily: "'Inter', system-ui, sans-serif" }}>
      {/* Header */}
